...
module.exports = class ApiGW {
	...
	async sync() {
		...
		if ('components' in openapi && 'securitySchemes' in openapi.components) {
			for (const [name, scheme] of openapi.components.securitySchemes) {
