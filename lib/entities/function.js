    ...
    async sync() {
        ...
        if (this.initialState) {
            try {
                ...
                this.serverless.cli.log(`Function updated ${this.newState.name}: ${requestParams.name}`);
            } catch (e) {
				console.error(e);
            ...
            try {
                ...
                this.id = response.id;
                this.serverless.cli.log(`Function created ${this.newState.name}: ${requestParams.name}`);
            } catch (e) {
